...
- [ ] 사용자에게 비상 근무 배정할 월과 시작 요일 입력 받기
  - [ ] 메시지: `비상 근무를 배정할 월과 시작 요일을 입력하세요> `
...
- [ ] 사용자에게 평일 비상 근무 순번대로 사원 닉네임 입력 받기
  - [ ] 메시지: `평일 비상 근무 순번대로 사원 닉네임을 입력하세요> `
  - [ ] 평일 순번과 휴일 순번의 순서는 다를 수 있다.

**휴일 비상 근무 (토요일, 일요일, 법정 공휴일)**

- [ ] 사용자에게 휴일 비상 근무 순번대로 사원 닉네임 입력 받기
  - [ ] 메시지: `휴일 비상 근무 순번대로 사원 닉네임을 입력하세요> `
